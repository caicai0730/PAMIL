...
if __name__ == '__main__':
    ...
    parser.add_argument('-d', '--dataset', type=str, default='TCGA', help='Dataset name')
    ...
    path_base = os.path.join('/data_disk/hj/wp/dataset', args.dataset)
    if len(levels) == 2:
        out_base = os.path.join('WSI', args.dataset, 'pyramid')
    else:
        out_base = os.path.join('/data_disk/hj/wp/dataset', args.dataset, 'single')
